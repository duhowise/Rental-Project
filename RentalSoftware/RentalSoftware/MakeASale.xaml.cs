...
namespace RentalSoftware
{
    ...
    private void button_Click(object sender, RoutedEventArgs e)
        ...
        private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            graphic.DrawString("ITEM DESCRIPTION", new Font("Arial", 12, System.Drawing.FontStyle.Bold), new SolidBrush(Color.Black), new RectangleF(new PointF(25, 380), new SizeF(500, 0)));
            ...
            //thank you
            graphic.DrawString("Thank you and come again.", new Font("Arial", 12, System.Drawing.FontStyle.Bold), new SolidBrush(Color.Black), new RectangleF(new PointF(280, 570 + starty), new SizeF(400, 0)));
